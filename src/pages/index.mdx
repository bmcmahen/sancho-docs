...
You can customize the theme using the `createTheme` and `generateColorsFromScales` functions. The example below demonstrates generating our own
color scales using [palx](https://palx.jxnblk.com/) and setting a custom font:

```
import { createTheme, generateColorsFromScales, ThemeProvider } from 'sancho'
